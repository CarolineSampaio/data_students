...
class UpdateStudentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            'nome' => 'string|max:100',
            'idade' => 'integer|min:1|max:100',
            'nota_primeiro_semestre' => 'numeric|min:0|max:10',
            'nota_segundo_semestre' => 'numeric|min:0|max:10',
            'nome_professor' => 'string|max:100',
            'numero_sala' => 'integer|min:1|max:99999',
        ];
    }
